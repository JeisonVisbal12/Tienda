...
public class Autenticacion extends javax.swing.JFrame {
    ...
    String Usuario = "jeison";
    String Contraseña = "1248";
    String us1,ct1;
    ...
    public void validacion_Ingreso(){
        us1 = Usu.getText();
        ct1 = new String(clav.getPassword());
        Ingreso_Producto ingreso = new Ingreso_Producto();
        if(us1.equals(Usuario) && ct1.equals(Contraseña)){
            ingreso.setVisible(true);
            this.dispose();
        }
        else{
            JOptionPane.showMessageDialog(null, "Contraseña o usuario incorrecto","Ingreso negado",JOptionPane.INFORMATION_MESSAGE);
            Usu.setText("");
            clav.setText("");
        }
    }
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(clav, javax.swing.GroupLayout.DEFAULT_SIZE, 189, Short.MAX_VALUE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(92, 92, 92)
